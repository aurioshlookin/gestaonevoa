                    ...
                    <div className="space-y-4">
                        <div className="bg-slate-900/50 p-4 rounded-lg border border-slate-700">
                            ...
                            <div className="mb-4">
                                ...
                                <select className={`w-full bg-slate-800 border border-slate-600 rounded p-2 text-white outline-none ${isReadOnly ? 'opacity-50' : ''}`} value={form.ninRole} onChange={(e) => setForm({...form, ninRole: e.target.value})} disabled={isReadOnly}>
