...
const MemberModal = ({ 
    ...
    // Adiciona cargos mapeados internamente (para Promoções e Clãs)
    if (isInternalMapping && orgDef?.internalRoles) {
        orgDef.internalRoles.forEach(r => {
            ...
            // Nota: secLeaderRoleConfig geralmente é automático pelo bot, mas adicionamos se quiser manual
    ...
    const handleInternalRoleChange = (e) => {
        ...
        // Se houver mapeamento interno, tenta preencher o cargo do Discord automaticamente
